...
export default function FormPage() {
  ...
  const phone = location.state?.phone || JSON.parse(sessionStorage.getItem("auth") || "{}").phone;
  ...
  return (
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: "640px" }}>
        {/* Card */}
        <div style={{
          background: cardBg, borderRadius: "24px", border: `1px solid ${cardBorder}`,
          boxShadow: dark
          ...
          <div style={{ padding: "32px" }}>
            ...
            <div style={{
              ...
              <div style={{
                background: dark ? "#0f172a" : "#f1f5f9", borderRadius: "16px", padding: "10px",
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
                ...
                <div>
                  ...
                  <div style={{
                    ...inputStyle, color: txtMuted, cursor: "not-allowed",
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
                <div>
                  ...
                  <input name="marks" value={form.marks} onChange={handleChange}
                    ...
                    onBlur={e => e.target.style.borderColor = inputBdr} />
                  <p style={{
                    marginTop: "6px", fontSize: "12px", color: "#d97706",
